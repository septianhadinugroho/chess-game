...
import { MULTIPLAYER_CONFIG } from '@/constants/multiplayer-config';
    ...
    <>
      <div className="card animate-slide-up">
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <button
            onClick={() => {
              if (MULTIPLAYER_CONFIG.IS_MAINTENANCE) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-white rounded-2xl p-5 max-w-sm w-full mx-4">
            <h3 className="font-bold text-gray-800 mb-2">
              {language === 'id' ? 'Sedang Maintenance' : 'Under Maintenance'}
            </h3>
            <p className="text-sm text-gray-600 mb-4">
              {MULTIPLAYER_CONFIG.MAINTENANCE_MESSAGE[language]}
            </p>
            <button
